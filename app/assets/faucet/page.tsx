...
export default function Balance() {
  ...
  return (
    <div className="bg-arena-bg text-white p-8 m-8 border border-b-[0.1px] border-white/20 rounded-lg w-full shadow-padentro  ">
      <p className="text-white">
        You can get some ETH tokens from the faucet. You can only use it once a
        day.
      </p>
      <Input
